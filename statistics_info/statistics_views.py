...
class GetContext():
    ...
    def get_3months_sales():
        ...
        try:
            ...
            all_dately_list = statisticsr.get_all_data()
            # データ成形
            formatter_dict_lists = statisticsr.get_target_data(all_dately_list)
            statisticsr.format_datetime(date_type, formatter_dict_lists)
            # ソートしたデータのみ取得
            sort_list = statisticsr.get_sort_value_list(formatter_dict_lists)
            # 日付とフルーツ情報を取得
            ...
            total_sum_list, rows_list = statisticsr.create_bill_info(bills_list)

            format_rows_list = statisticsr.format_bill_info(monthly_key_list, total_sum_list, rows_list)
    ...
    def get_3days_sales():
        ...
        try:
            ...
            format_rows_list = statisticsr.format_bill_info(dately_key_list, total_sum_list, rows_list)
